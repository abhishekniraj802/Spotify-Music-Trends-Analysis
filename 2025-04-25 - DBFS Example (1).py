...
survived_passengers = df.filter(df["Survived"] == "1").count()
print(f"Passengers who survived: {survived_passengers}")


# COMMAND ----------

# Group by passenger class (Pclass) and count the number of passengers in each class
